...
<html lang="en">
	<head>
		<meta charset="utf-8">
		<title>Letter History - LETTREQUEST</title>
			...
			<div id="section">
				<div class="title">
					...
					<table class="hov fancy" style="width:95%;">
						...
						?>
								<tr>
								    <td><?php echo $row->LetterNumber; ?>/IT2.5.I.1/LR/2017</td>
								    ...
								    {
								    ?>
									    <td><a href="<?php echo base_url('index.php/requestcontroller/editrequest/').'/'.$row->LetterNumber; ?>"><button class="button green">Edit</button></a></td>
									    <td style="width:10%;">
									    	<button class="button red confirm"><a href="<?php echo base_url('index.php/requestcontroller/deleterequest/').'/'.$row->LetterNumber; ?>" onclick="return confirm('Are you sure to cancel this request?')"> Cancel </a></button>
									    </td>
								    <?php
									}
									else
									{
									?>
										<td><a href="#"><button class="button normal" disabled>Edit</button></a></td>
									    <td><a href="#"><button class="button normal" disabled>Cancel</button></a></td>
									<?php
									}
								    ?>
								</tr>
